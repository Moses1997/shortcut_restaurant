                ...
                onTap: (){
                  showMaterialModalBottomSheet(
                    ...
                    builder: (context) => SingleChildScrollView(
                      child: InkWell(
                        onTap: () async {
                         if (await canLaunchUrlString("tel://${_order.deliveryAddress.contactPersonNumber}")) {
                          await launchUrlString("tel://${_order.deliveryAddress.contactPersonNumber}");
                         }
                        },
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                            Text(
                              _order.deliveryAddress.contactPersonName, maxLines: 3, overflow: TextOverflow.ellipsis,
                              style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE),
                            ),
                            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                            Text(
                              _order.deliveryAddress.contactPersonNumber, maxLines: 3, overflow: TextOverflow.ellipsis,
                              style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).disabledColor),
                            ),
                            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                            Text(
                              _order.deliveryAddress.address, maxLines: 3, overflow: TextOverflow.ellipsis,
                              style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).disabledColor),
                            ),
                            SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                            (_order.deliveryAddress.streetNumber != null && _order.deliveryAddress.streetNumber.isNotEmpty) ? Text('street_number'.tr+ ': ' + _order.deliveryAddress.streetNumber  + '${(_order.deliveryAddress.house != null && _order.deliveryAddress.house.isNotEmpty) ? ', ' : ' '}',
                              style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).disabledColor), maxLines: 2, overflow: TextOverflow.ellipsis,
                            ) : SizedBox(),
